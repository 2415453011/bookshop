	...
	<script type="application/javascript">
		$(function () {
			...
			$(".updateCount").change(function () {
				...
				//	发起请求,给服务器保存修改
					location.href = "cart/update.do?count=" + count + "&id=" + id;
				}else {
...
<div id="main">
	...
	<table>
		...
		<c:forEach items="${sessionScope.cart.items}" var="entry">
			...
			<tr>
				...
				<td><a class="deleteItem" href="cart/deleteCatItem.do?id=${entry.value.id}">删除</a></td>
			</tr>
		</c:forEach>
		</c:if>
	...
	<c:if test="${not empty sessionScope.cart.items}">
		<div class="cart_info">
			...
			<span class="cart_span"><a class="clear" href="cart/clear.do">清空购物车</a></span>
			<span class="cart_span"><a class="checkout" href="order/client/creatOrder.do">去结账</a></span>
		</div>
	</c:if>
